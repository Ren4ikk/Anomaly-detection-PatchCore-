...
poetry run python scripts/run.py --train_dir $TrainDir --test_dir $TestDir --mask_dir $MaskDir --save_path $SavePath --coreset_ratio $CoresetRatio --batch_size $BatchSize --num_workers $NumWorkers --verbose